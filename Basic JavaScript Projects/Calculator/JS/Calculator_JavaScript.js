...
const Calculator = 
    {
        ...
        //This will hold the operator, we set it to the null for now
        operator: null,
    };
...
function Input_Digit(digit)
{
    ...
    {
        //This overrides Display_Value if the current value is 0
...
function Handle_Operator(Next_Operator)
{
    ...
    else if(operator) //Checks if an operator already exists
    {
        ...
        //in the Perfom_Calculation object and the function that matches
